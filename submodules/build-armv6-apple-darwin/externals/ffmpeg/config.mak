...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/chris/Code/Gargoyle/linphone-iphone/submodules/build/..//../liblinphone-sdk/armv6-apple-darwin --disable-mmx --enable-cross-compile --disable-ffprobe --disable-ffserver --disable-avdevice --disable-avfilter --disable-network --disable-everything --enable-decoder=mjpeg --enable-encoder=mjpeg --enable-decoder=mpeg4 --enable-encoder=mpeg4 --enable-decoder=h264 --disable-avformat --enable-armv5te --enable-armv6 --enable-armv6t2 --enable-armvfp --cross-prefix=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/ --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk --arch=armv6 --enable-static --disable-shared --target-os=darwin --extra-cflags='-arch armv6 ' --extra-ldflags='-arch armv6 -Wl,-syslibroot,/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk ' --source-path=/Users/chris/Code/Gargoyle/linphone-iphone/submodules/build/..//externals/ffmpeg --cpu=arm1176jzf-s
...
BUILD_ROOT="/Users/chris/Code/Gargoyle/linphone-iphone/submodules/build-armv6-apple-darwin/externals/ffmpeg"
...
CPPFLAGS= --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
CFLAGS= -arch armv6 -mcpu=arm1176jzf-s -std=c99 -mdynamic-no-pic -fomit-frame-pointer -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
ASFLAGS= -arch armv6 -mcpu=arm1176jzf-s -mdynamic-no-pic -g
CC_O=-o $@
DLLTOOL=
LDFLAGS= -arch armv6 -Wl,-syslibroot,/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -Wl,-dynamic,-search_paths_first
